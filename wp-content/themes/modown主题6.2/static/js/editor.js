               ...
               ed.addButton( 'button_gallery', {
                    ...
                    onclick : function() {
                         ed.windowManager.open( {
                              ...
                              onsubmit: function( e ) {
                                   ed.selection.setContent('[gallery_modown'+(e.data.urls?' urls="'+e.data.urls+'"':'')+(e.data.vip?' vip="'+e.data.vip+'"':'')+(e.data.hide?' hide="'+e.data.hide+'"':'')+(e.data.preview?' preview="'+e.data.preview+'"':'')+(e.data.columns?' columns="'+e.data.columns+'"':'')+(e.data.crop?' crop="'+e.data.crop+'"':'')+']');
                              }
                         });
                    }
               });
               ...
               ed.addButton( 'button_catag', {
                    ...
                    onclick : function() {
                         ed.windowManager.open( {
                              ...
                              onsubmit: function( e ) {
                                   ed.selection.setContent('['+e.data.type+(e.data.new?' new="'+e.data.new+'"':'')+(e.data.id?' id="'+e.data.id+'"':'')+(e.data.num?' num="'+e.data.num+'"':'')+(e.data.title?' title="'+e.data.title+'"':'')+(e.data.link?' link="'+e.data.link+'"':'')+(e.data.orderby?' orderby="'+e.data.orderby+'"':'')+(e.data.style?' style="'+e.data.style+'"':'')+(e.data.cols?' cols="'+e.data.cols+'"':'')+']');
                              }
                         });
                    }
               });
