								...
								<table class="erphpdown-table" width="100%" align="center">
									...
									<tr>
										...
										?>
											...
											<?php }?>
											<?php if(get_option('erphpdown_epay_id') && plugin_check_epay()){?> 
												<?php if(!get_option('erphpdown_epay_wxpay')){?><a href="<?php echo ERPHPDOWN_EPAY_URL."/epay.php?ice_post=".$postid."&index=".$index."&type=wxpay&redirect_url=".urlencode(get_permalink($postid));?>" class="pmt-wx erphpdown-jump" target="_blank"><i class="erphp-iconfont erphp-icon-wxpay"></i> 微信支付</a><?php }?>  
												<?php if(!get_option('erphpdown_epay_alipay')){?><a href="<?php echo ERPHPDOWN_EPAY_URL."/epay.php?ice_post=".$postid."&index=".$index."&type=alipay"."&redirect_url=".urlencode(get_permalink($postid));?>" class="pmt-ali erphpdown-jump" target="_blank"><i class="erphp-iconfont erphp-icon-alipay"></i> 支付宝</a><?php }?>
											<?php }?>
						...
						<table class="erphpdown-table" width="100%" align="center">
							...
							<tr>
								...
								?>
									...
									<?php }?>
									<?php if(get_option('erphpdown_epay_id') && plugin_check_epay()){?> 
										<?php if(!get_option('erphpdown_epay_wxpay')){?><a href="<?php echo ERPHPDOWN_EPAY_URL."/epay.php?ice_post=".$postid."&type=wxpay&redirect_url=".urlencode(get_permalink($postid));?>" class="pmt-wx erphpdown-jump" target="_blank"><i class="erphp-iconfont erphp-icon-wxpay"></i> 微信支付</a><?php }?>  
										<?php if(!get_option('erphpdown_epay_alipay')){?><a href="<?php echo ERPHPDOWN_EPAY_URL."/epay.php?ice_post=".$postid."&type=alipay"."&redirect_url=".urlencode(get_permalink($postid));?>" class="pmt-ali erphpdown-jump" target="_blank"><i class="erphp-iconfont erphp-icon-alipay"></i> 支付宝</a><?php }?>
									<?php }?>
									<?php if(get_option('ice_payapl_api_uid')){?> 
										<a href="<?php echo constant("erphpdown")."payment/paypal.php?ice_post=".$postid."&index=".$index."&redirect_url=".urlencode(get_permalink($postid));?>" class="pmt-pp erphpdown-jump" target="_blank"><i class="erphp-iconfont erphp-icon-paypay"></i> Paypal</a>
									<?php }?>
