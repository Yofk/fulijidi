			...
			<tr>
				...
				<td>
					<select name="member_down_default">
 						...
 						<option value ="11" <?php if($member_down_default == '11') echo 'selected="selected"';?>>专享购买年费5折</option>
 						<option value ="12" <?php if($member_down_default == '12') echo 'selected="selected"';?>>专享购买年费8折</option>
 					</select>
				</td>
			</tr>
			<tr>
